module.exports = {
  ...
  embed: {
    color: process.env.color || "#008eed",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Md Jamshed Alam | DUDE",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  // others
  guildID: process.env.guildID || "599662086406275084", // for slash command
  mongodb : process.env.mongodb || "mongodb+srv://jamshed:98409840@realmcluster.qyft1.mongodb.net/dudemusicv2",
  filters: {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1047761976174055425&permissions=8&scope=bot%20applications.commands`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/fQhJsYZfgp`,
    VoteURL: process.env.VoteURL || `https://discord.gg/fQhJsYZfgp`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true 
